                    ...
                    <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                        ...
                        <tr>
                            <td align='center' height='70' style='height:70px;'>
                                <a href='' style='display: block; border-style: none !important; border: 0 !important;'><img width='100' border='0' style='display: block; width: 300px;' src="{{ asset('logo.png') }}" alt="Logo" /></a>
                            </td>
                        </tr>
                    </table>
                </td>
                            ...
                            <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                                <tr>
                                    <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        <!-- section text ======-->
                                        <h2>Dear  {{$otp['first_name']}}</h2>
                                        <br>
                                        <br>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                        Your one-time email verification token: 
                                        </p>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                          {{$otp['otp']}}
                                        </p>
