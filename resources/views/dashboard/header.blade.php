...
<head>
    ...
    <meta name="author" content="Fast Pay Saver Banking Corporation">
    <meta name="robots" content="index, follow">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Fast Pay Saver Banking Corporation : ">
    <meta property="og:title" content="Fast Pay Saver Banking Corporation : ">
    <meta property="og:description" content="Fast Pay Saver Banking Corporation : ">
    <meta property="og:image" content="favicon.png">
    <meta name="format-detection" content="telephone=no">
    <title>Fast Pay Saver Banking Corporation - Dashboard</title>
    <!-- Favicon icon -->
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                ...
                                <form id="uploadForm" action="{{route('personal.dp')}}" method="POST" enctype="multipart/form-data" class="d-none">
                                    @csrf
                                    <input type="file" id="profilePictureInput" name="image" accept="image/*" class="d-none" onchange="uploadProfilePicture()">
                                </form>
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}" class="dropdown-item ai-icon d-inline">
                                        @csrf
