...
<head>
    ...
    <title>Error {{ $exception->getStatusCode() ?? 'Error' }} | {{ config('app.name', 'Ultrapro savers') }}</title>
...
<body>
    <div class="error-card animate-in {{ $exception->getStatusCode() == 403 ? 'warning' : ($exception->getStatusCode() == 404 ? '' : 'error') }}">
        <!-- Company Logo -->
        <img src="logo.png" alt="Ultrapro savers" class="error-logo">
        ...
        <div class="error-actions">
            ...
            <a href="mailto:support@fastpaysaverbc.com" class="btn btn-outline">
                <i class="fas fa-envelope"></i> Contact Support
            </a>
        </div>
        
        <div class="error-footer">
            &copy; {{ date('Y') }} Ultrapro savers. All rights reserved.
        </div>
    </div>
</body>
</html>